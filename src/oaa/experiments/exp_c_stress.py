...
def run_experiment_noise_with_barriers(use_simulator=False):
    ...
    target_prob = 0.001  # Výchozí pravděpodobnost, kterou chceme zesílit (5%)
    shots = 2048
    ...
    handler = DataHandler(base_dir="results/oaa/exp_c", file_name="exp_c_stress")
    ...
    print("\nExperiment C dokončen! Všechna data najdeš ve složce results/oaa/exp_c.")
    handler.generate_comparison_plot()

if __name__ == "__main__":
    run_experiment_noise_with_barriers(False)